...
while not correct: # loops while a correct answer has not been inputted
  ...
  if(guess > num and guessnum > 1): # checks if the guess is greater than the generated number
  ...
  if(guess < num and guessnum > 1): # checks if the guess is less than the generated number
