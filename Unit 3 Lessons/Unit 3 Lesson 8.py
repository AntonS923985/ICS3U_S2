"""
1) Hypothermia
Hypothermia is when the body core temperature is below 35°C in humans. In mild hypothermia, there is shivering and mental confusion. In moderate hypothermia, there is no more shivering and confusion increases.
2) Frostbite
